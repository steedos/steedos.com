...
export function Header({ hasNav = false, navIsOpen, onNavToggle, title, section }) {
  ...
  return (
    <>
      ...
      <header className="sticky relative top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-white supports-backdrop-blur:bg-white/95 dark:bg-slate-900/75">
                ...
                <div className="relative hidden lg:flex items-center ml-auto">
                  ...
                  <a className="hover:text-gray-500 dark:hover:text-gray-400 text-sm font-medium " href="/company/contact-us" target="_blank">
                    ...
                    <div class="dropdown dropdown-hover">
                      <div tabindex="0" role="button" class="ml-2 font-medium text-sm leading-5 rounded-full text-sky-600 bg-sky-400/10 px-3 py-2  dark:text-sky-400"><a href="https://demo.steedos.cn/" target="_blank">在线试用</a></div>
