...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-6xl leading-tight sm:leading-tight	dark:text-slate-200">
       {'华炎魔方，'}
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">超越简单的应用构建</span>
        </span>{' '}<br/>
        释放真正的低代码能力
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <a target="_blank" href="https://docs.steedos.com" className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900">
          快速开始
        </a>
        <a target="_blank" href="https://docs.steedos.com/developer" className="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-200 text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300">
          开发文档
        </a>
      </div>
