      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'AI 智能设备', href: '/resources/features/iot' },
            { name: '全部 人工智能', href: '/resources/artificial-intelligence' },
          ],
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { name: '建筑和房地产', href: '/resources/industries/construction-real-estate' },
            { name: '石油天然气和能源', href: '/resources/industries/oil-gas-energy' },
            { name: '工业制造', href: '/resources/industries/industrial-manufacturing' },
            { name: '高科技', href: '/resources/industries/high-tech' },
            { name: '教育', href: '/resources/industries/education' },
            { name: '政府', href: '/resources/industries/goverment' },
            { name: '全部行业', href: '/resources/industries' },
          ],
        },
        {
          id: 'customer-cases',
