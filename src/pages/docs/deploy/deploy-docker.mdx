...
- [从 Github 下载](https://raw.githubusercontent.com/steedos/steedos-project-template/2.2/docker-compose.yml)
- [从 Gitlab 下载](https://gitlab.steedos.cn/steedos/steedos-project-template/-/raw/2.2/docker-compose.yml)
